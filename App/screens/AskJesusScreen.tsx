...
import { auth, db } from '../config/firebaseConfig'; // ✅ corrected
import ScreenContainer from '../components/theme/ScreenContainer';
import { theme } from '../components/theme/theme';
import { getTokenCount, setTokenCount } from '../utils/TokenManager'; // ✅ corrected
import { ASK_GEMINI_CONVERSATION } from '../utils/constants'; // ✅ corrected
...
export default function AskJesusScreen() {
    ...
    const handleAsk = async () => {
        ...
        try {
            ...
            if (subscribed) {
                setMessages(prev => [...prev, `User: ${question}`, `Jesus: ${answer}`]);
            } else {
                setMessages([`User: ${question}`, `Jesus: ${answer}`]);
            }
