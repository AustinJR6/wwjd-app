    ...
    <ScreenContainer>
      <View style={styles.content}>
        ...
        <View style={styles.pack}>
          <Text style={styles.amount}>5 Tokens — <Text style={styles.price}>$1.99</Text></Text>
          <Button title="Buy 5 Tokens" onPress={() => purchase(5)} />
        </View>

        <View style={styles.pack}>
          <Text style={styles.amount}>15 Tokens — <Text style={styles.price}>$4.99</Text></Text>
          <Button title="Buy 15 Tokens" onPress={() => purchase(15)} />
        </View>

        <View style={styles.pack}>
          <Text style={styles.amount}>40 Tokens — <Text style={styles.price}>$9.99</Text></Text>
